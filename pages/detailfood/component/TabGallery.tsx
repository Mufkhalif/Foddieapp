...
export default ({route, navigation, active, initialName}: any) => {
  const {item} = route.params;
  const status = useSpringTransition(active == 'gallery' ? true : false);
    ...
    <Animated.View style={{transform: [{translateX: transX}]}}>
      <View style={styles.middleContainer}>
        ...
        <View style={styles.rightTab}>
          <Text style={styles.rightTitle}>Gallery</Text>
          <View
